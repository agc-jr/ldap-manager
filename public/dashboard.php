...
<?php if ($ldapError): ?>
  <div class="card p-6 mb-6 border-rose-500/30 bg-rose-500/5">
    <p class="text-sm text-rose-300 font-medium">
      <?php $dom = ActiveDomain::temAlgum() ? ActiveDomain::atual() : null; ?>
      <?= $dom !== null
            ? 'Não foi possível conectar ao domínio ' . htmlspecialchars((string) $dom['name'])
